...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previwUrl }) => {
  return (
    <div>
      ...
      >
        <div className="overlay flex items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 gap-5">
          <Link
            href={gitUrl}
