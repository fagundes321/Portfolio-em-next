...
const Photo = () => {
  return (
    <div className="w-full h-full relative animate__animated animate__slow animate__fadeInRight ">
      <motion.div>
      {/* absolute w-[300px] h-[300px] xl:w-[500px] xl:h-[500px]  rounded-full overflow-hidden  mix-blend-lighten" */}
        <div className="flex items-center justify-center h-screen overflow-hidden rounded-full absolute w-[298px] h-[298px] xl:w-[488px] xl:h-[488px] mix-blend-color">
          <Image
